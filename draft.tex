...
\begin{figure}[h]
    \caption{Plot of $\frac{F_{fast}}{A}$ as a function of N.}
    \includegraphics[width=\textwidth]{f_fast}
\end{figure}
If we plug (\ref{optimal_n_ffast}) back into (\ref{grass_cover}), our expression for equilibrium grass cover, we get $g = 0.5$. This should make sense - the derivative of the logistic function is maximum when $f(x) = 0.5$.

Let's also note that there is a certain population of sheep for which the equilibrium grass cover is zero:
